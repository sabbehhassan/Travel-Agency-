...
const AdminDashboard = () => {
  ...
  const fetchTourBookings = useCallback(async () => {
    try {
      const res = await fetch("http://VITE_API_BASE_URL/api/bookings/admin/bookings", {
  ...
  const fetchHotelBookings = useCallback(async () => {
    try {
      const res = await fetch("http://VITE_API_BASE_URL/api/bookings/admin/hotelbookings", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const updateStatus = async (type, id, status) => {
    try {
      const endpoint =
        type === "hotel"
          ? `http://VITE_API_BASE_URL/api/bookings/admin/hotelbookings/${id}/status`
          : `http://VITE_API_BASE_URL/api/bookings/admin/bookings/${id}/status`;
